...
## Acceptance Criteria
- [ ] Snake data structure stores segments as {x, y} coordinates
- [ ] Snake initializes at center of grid with length of 3 segments
- [ ] Snake moves continuously in current direction at fixed intervals
- [ ] Arrow key input changes snake direction correctly
- [ ] Direction reversals are prevented (can't go left when moving right)
- [ ] Input queue prevents multiple direction changes per game tick
- [ ] Snake growth logic adds new segment when triggered
- [ ] Head position calculated correctly based on direction
- [ ] Tail removal works properly (except when growing)
- [ ] Movement is smooth and grid-aligned
...
## Dependencies
- [ ] Task 002 completed (game loop and state management)
...
## Definition of Done
- [ ] Snake data structure implemented correctly
- [ ] Snake spawns at center with 3 segments facing right
- [ ] Continuous movement works at correct speed
- [ ] All four arrow keys control direction properly
- [ ] Cannot reverse direction (validated and tested)
- [ ] Input queue prevents double-input glitches
- [ ] Growth logic adds exactly one segment
- [ ] Movement is smooth and grid-aligned
- [ ] No stuttering or irregular movement
- [ ] Edge cases tested (rapid key presses, boundary moves)
- [ ] Code is well-commented
- [ ] Keyboard event listeners properly attached/detached
